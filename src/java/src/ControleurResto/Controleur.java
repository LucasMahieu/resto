...
public class Controleur{
	...
	public LinkedList<String> getListeArticles(String type)
	{
		...
		try {
			//String nomArticle, float prixArticle, String specialite, String type, String date, String service
			ResultSet rset = ReservationFactoryConcrete.get().getArticleBD().getArticle(null, -1, null,null,null, type);
			if (rset == null) {
				return resultat;
			}
			while(rset.next()){
	...
	public LinkedList<String> getListeArticlesMenu(String nomMenu, String type)
	{
		...
		//String nomMenu, String type, String date, String service
		LinkedList<String> resultat = ReservationFactoryConcrete.get().getArticleBD().getArticleMenu(nomMenu, type,this.getDateNow(),this.getServiceNow());
		return resultat;
	}
